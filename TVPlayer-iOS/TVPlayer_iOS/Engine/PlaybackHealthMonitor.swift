...
final class PlaybackHealthMonitor {
    ...
    // 配置阈值（偏稳：健康度仅观测，真正换线在 PlayerEngine 无数据策略）
    private let videoFreezeThreshold: TimeInterval = 8.0
    private let bufferEmptyThreshold = 6
    private let stallThreshold = 5
