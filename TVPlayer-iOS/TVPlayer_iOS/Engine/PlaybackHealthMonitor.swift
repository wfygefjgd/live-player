...
final class PlaybackHealthMonitor {
    ...
    // 配置阈值（健康度仅作观测参考，真正换线由 PlayerEngine 多信号融合决定）
    private let videoFreezeThreshold: TimeInterval = 10.0
    private let bufferEmptyThreshold = 8
    private let stallThreshold = 6
